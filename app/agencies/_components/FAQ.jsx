    ...
    const faqs = [
        {
            ...
            ans: [
                { type: "text", text: "Brands approach influencer marketing agencies with a brief asking for a campaign that improves conversions, traffic, downloads, and/or awareness by working with influencers. Once appointed the agency would:" },
                {
                    type: "bullet", bullets: [
                                                ...
                                                <ul key={i} className='list-disc' >
                                                    {
                                                        item.bullets.map((list, i) => {
                                                            return (
                                                                <li key={i} className='ms-9'>{list}</li>
                                                            )
                                                        })
                                                    }
                                                </ul>
