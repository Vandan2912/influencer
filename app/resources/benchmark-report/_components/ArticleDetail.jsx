...
const ArticleDetail = () => {
    return (
        <div className='mt-10 text-base'>
            ...
            <h1 className='text-3xl font-bold'>The State of Influencer Marketing 2024:<br />Benchmark Report</h1>
            ...
            <p>
                ...
                As well as our annual survey collating data related to the influencer marketing industry, the Influencer Marketing Benchmark Report 2024 also incorporates data from HypeAuditor, and our <a href='#' className='text-[#EB3C75]'>Diversity, Equity & Inclusion (DEI) in Influencer Marketing: Racial and Gender Inequalities Report.</a>
            </p>
            ...
            <h2 id='platform-preferences-in-fnfluencer-marketing' className='text-xl font-bold mb-3 mt-5'>The State of Influencer Marketing Benchmark Report 2024:</h2>
            {/* Summary */}
            <div className="mt-5">
            ...
            <h2 id='platform-preferences-in-fnfluencer-marketing' className='text-xl font-bold mb-3 mt-5'>Notable Highlights</h2>
            ...
            <h2 id='budget-allocation-across-influencer-tiers' className='text-xl font-bold mb-3 mt-5'>Survey Methodology</h2>
            <p>
