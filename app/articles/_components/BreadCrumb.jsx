...
const BreadCrumb = () => {
    ...
    return (
        <div className='bg-[#FBF9F9] pt-36 p-16 grid grid-cols-6 gap-16 min-h-[30vh]'>
            <div className='col-span-4 flex flex-col'>
                <div className='flex items-center gap-5 w-full text-sm'>
                ...
                <p className='text-4xl font-bold mt-10 mb-5'>May 2024 Influencer Marketing Report</p>
                <div className='flex justify-between items-center gap-5 w-full text-sm'>
