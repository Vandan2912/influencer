...
// import image6 from "../../assets/articles6.png";
import Image from "next/image";

const Articles = () => {
  return (
    <section className="px-28 py-40 w-full min-h-[80vh]">
      <p className="text-4xl text-center font-semibold">Latest Articles</p>
      <div className="grid grid-cols-12 gap-6 mt-10">
        ...
        />
        <div
          className="col-span-6 bg-[#00000025] rounded-[20px] relative"
          style={{
        ...
        >
          ...
          <div
            className="p-7 h-full flex flex-col justify-center rounded-[20px]"
            style={{
              background:
          ...
          >
            ...
            <p className="bg-[#00000035] w-fit px-2 rounded-md mt-2">Digital Marketing</p>
          </div>
        </div>
      </div>
      <div className="text-[#EB3C75] text-center mt-10 underline">See All Articles</div>
    </section>
  );
};
...
const Card = ({ image, title, desc, className }) => {
  return (
    <div className={`${className} bg-[#00000015] rounded-[20px] pb-6`}>
      ...
      <div className="p-5">
        <p className="bg-[#00000035] w-fit px-2 rounded-md">Digital Marketing</p>
