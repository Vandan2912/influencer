...
const PlatformCard = ({ data }) => {
    ...
    return (
        <div className='group grid grid-cols-12 gap-8 border border-[#00000033] hover:shadow-[0_0_11px_rgba(33,33,33,.2)] duration-300 rounded-[20px] p-5'>
            <div className='col-span-12 sm:col-span-3 lg:col-span-2 overflow-hidden'>
                <img src={`/platforms/${data.image}`} alt="" className='w-full h-full object-contain group-hover:scale-110 duration-300' />
            </div>
