    ...
    return (
        <div className='mt-10 text-base'>
            <p>
                ...
                The Influencer Marketing Report May 2024 provides an in-depth look at the current state of the <a href='#' className='text-[#EB3C75]'>influencer marketing industry</a>.
                Based on a survey of 237 marketing professionals, this report highlights their perspectives on the evolving landscape, the challenges they face, and their strategies for success. Given the rapid changes in the digital marketing world, we believe it is crucial to share monthly insights to keep you updated on the latest trends and developments.
            </p>

            <div id='note' className='bg-[#EFEFEF] border-l-[1rem] border-l-[#EB3C75] p-8 my-5 rounded-se-2xl rounded-ee-2xl'>
                In our survey marketing professionals revealed a landscape where 66.8% are planning to increase their <a href='#' className='text-[#EB3C75]'>influencer marketing budgets</a> in the coming year, signaling a robust confidence not seen in other sectors.
                This contrasts sharply with the general anxiety surrounding more traditional digital marketing tactics, such as SEO, which constantly grapple with <a href='#' className='text-[#EB3C75]'>Google&apos;s algorithm changes</a>.
            </div>


            <h2 id='platform-preferences-in-fnfluencer-marketing' className='text-xl font-bold mb-3 mt-5'>Platform Preferences in Influencer Marketing</h2>
            <p>
            ...
            <h2 id='budget-allocation-across-influencer-tiers' className='text-xl font-bold mb-3 mt-5'>Budget Allocation Across Influencer Tiers</h2>
            <p>
