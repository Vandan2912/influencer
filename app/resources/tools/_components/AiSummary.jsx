...
const AiSummary = () => {
    return (
        <div className='flex items-center gap-3 md:gap-10 bg-[#FBF9F9] rounded-xl py-5 md:py-6 px-5 md:px-10'>
            ...
            <Button className="bg-[#EB3C75] hover:bg-[#860e35] duration-300 border w-fit border-[#EB3C75] rounded-full py-1 px-5 md:px-8 text-white mt-5 flex items-center gap-3">
                Summarize
            </Button>
        </div>
    )
